...
- C# / .NET 10.0 + Assertivo 0.3.0 (was 0.2.0), xUnit v3 3.2.2 (unchanged) (00016-assertivo-upgrade-allsatisfy)
...
## Recent Changes
- 00016-assertivo-upgrade-allsatisfy: Added C# / .NET 10.0 + Assertivo 0.3.0 (was 0.2.0), xUnit v3 3.2.2 (unchanged)
